...
document.addEventListener('keydown', function(event) {
  ...
  switch (event.keyCode) {
    // オプションで変更可能なキーコード
    case 80: togglePlayAndPause(); break; // default: P
    case 72: jumpToBeginning();    break; // default: H
    case 69: jumpToEnd();          break; // default: E
    // case 82: partialLoop();        break; // default: R
    // 固定のキーコード
    case 37: rewindTime();         break; // left-allow
    case 39: advanceTime();        break; // right-allow
